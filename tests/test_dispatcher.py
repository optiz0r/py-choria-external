...
from choria_external.dispatcher import read_request, write_reply


class TestDispatcher(unittest.TestCase):

    @mock.patch('choria_external.dispatcher.open')
    ...
    @mock.patch('choria_external.dispatcher.sys.stdin')
    ...
    @mock.patch('choria_external.dispatcher.print')
